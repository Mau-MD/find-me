...
export const updateRouter = router({
  updatePostVisto: protectedProcedure
    .input(
      z.object({
        userId: z.string(),
        color: z.custom(),
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      if (post === null) {
        ...
        if (input.detallesPerro) {
          post.detallesPerro = input.detallesPerro;
        }
        if (input.detallesPlaca) {
          post.detallesPlaca = input.detallesPlaca;
        }
        if (input.edad) {
          post.edad = input.edad;
        }
  ...
  updateCasoAbierto: protectedProcedure
    .input(
      z.object({
        id: z.string(),
      })
  ...
  updatePostPerdido: protectedProcedure
    .input(
      z.object({
        color: z.custom(),
